...
<head>
    ...
    <title>Learning Experiences - Hsu Sandi Bo</title>
...
<body class="body-margin">
    ...
    <nav class="navbar navbar-expand-lg justify-content-center">
        <div class="navbar-nav nav-tabs menuBar">  <!--d-none d-lg-inline not work in here-->
            <a class="nav-item nav-link me-3" href="index.php" target="_blank">Home</a>
            <a class="nav-item nav-link me-3" href="about.php">About Me</a>
            <a class="nav-item nav-link active me-3" href="#">Learning Experiences</a>
    ...
    <h2 class="experience-title">LEARNING EXPERIENCES</h2><hr>
    <div class="row flex-column flex-lg-row">
        <img class="learning-image" src="images/japanese2.jpg">
        <div class="col"><p class="p-right">I've started learning japanese from 2020. I've studied about two hours a day for almost one year. 
            Finally, I've passed Japanese Nat-test N4 level. Now, I'm studying for next level.</p></div>
    </div><hr>

    <div class="row flex-column flex-lg-row">
        <img class="learning-image" src="images/english1.png">
        <div class="col"><p class="p-right">English is the second language that I have learned since primary school. 
            So, I'm more confident with this than other languages. 
            Now, my English level is intermediate(B1) Level and I'm learning to be more improved in my English skills.</p></div>
    </div><hr>

    <div class="row flex-column flex-lg-row">
        <img class="learning-image" src="images/web-developer.jpg">
        <div class="col"><p class="p-right">During the crisis, I've been learning web developing from Dr.Ei Maung's book with my Aunt. 
            I've studied about six hours per week for nine months.
            Right now, I've finished all lessons in book but I have to practice to be more improved.</p></div>
    </div><hr>

    <div class="row flex-column flex-lg-row">
        <img class="learning-image" src="images/python1.png">
        <div class="col"><p class="p-right">I've started learning Python about one year ago.
            Now I'm beginner level in Python, then I'll try and learn my best for advanced level.</p></div>
    </div><hr>
